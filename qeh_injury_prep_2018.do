** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			qeh_injury_prep_2018.do
    ...
    ** Close any open log fileand open a new log file
    capture log close
    cap log using "`logpath'\qeh_injury_prep_2018", replace
** HEADER -----------------------------------------------------
...
label data "QEH Injury data: 2018"
save "`datapath'\version01\2-working\qeh_injury_2018", replace 
