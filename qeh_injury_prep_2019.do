** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			qeh_injury_prep_2019.do
    ...
    ** Close any open log fileand open a new log file
    capture log close
    cap log using "`logpath'\qeh_injury_prep_2019", replace
** HEADER -----------------------------------------------------
...
** Full dataset 
import excel using "`datapath'/version01/1-input/AED Log for January-June 2019.xlsx", first
...
label data "QEH Injury data: 2019"
save "`datapath'\version01\2-working\qeh_injury_2019", replace 
