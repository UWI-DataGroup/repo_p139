** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			qeh_injury_prep_2017.do
    ...
    ** Close any open log fileand open a new log file
    capture log close
    cap log using "`logpath'\qeh_injury_prep_2017", replace
** HEADER -----------------------------------------------------
...
** Full dataset 
import excel using "`datapath'/version01/1-input/AED Log- January-December 2017.xlsx", first
...
label data "QEH Injury data: 2017"
save "`datapath'\version01\2-working\qeh_injury_2017", replace 
